...
<body class="bg-gradient-to-br from-gray-900 to-black text-white" style="background-color: #1E1E1E;">
    ...
    <nav class="flex justify-between items-center p-5">
        ...
        <div>
            <a href="{{ route('signup') }}"><button class="bg-blue-900 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded">Sign Up</button></a>
            <a href="{{ route('login') }}"><button class="text-white font-semibold hover:text-blue-300">Login</button></a>
        </div>
    </nav>
    ...
    <div class="flex justify-between items-center px-20 py-10">
        <div class="max-w-xl">
            ...
            <a href="{{ route('trynow') }}"><button class="bg-blue-900 hover:bg-blue-900 text-white font-bold py-2 px-8 rounded">Try Now</button></a>
        </div>
